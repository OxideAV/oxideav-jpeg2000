...
const STATES: [State; 94] = [
    State { qeval: 0x5601, mps: 0, nlps: 3, nmps: 2 },
    State { qeval: 0x5601, mps: 1, nlps: 2, nmps: 3 },
    State { qeval: 0x3401, mps: 0, nlps: 12, nmps: 4 },
    State { qeval: 0x3401, mps: 1, nlps: 13, nmps: 5 },
    State { qeval: 0x1801, mps: 0, nlps: 18, nmps: 6 },
    State { qeval: 0x1801, mps: 1, nlps: 19, nmps: 7 },
    State { qeval: 0x0ac1, mps: 0, nlps: 24, nmps: 8 },
    State { qeval: 0x0ac1, mps: 1, nlps: 25, nmps: 9 },
    State { qeval: 0x0521, mps: 0, nlps: 58, nmps: 10 },
    State { qeval: 0x0521, mps: 1, nlps: 59, nmps: 11 },
    State { qeval: 0x0221, mps: 0, nlps: 66, nmps: 76 },
    State { qeval: 0x0221, mps: 1, nlps: 67, nmps: 77 },
    State { qeval: 0x5601, mps: 0, nlps: 13, nmps: 14 },
    State { qeval: 0x5601, mps: 1, nlps: 12, nmps: 15 },
    State { qeval: 0x5401, mps: 0, nlps: 28, nmps: 16 },
    State { qeval: 0x5401, mps: 1, nlps: 29, nmps: 17 },
    State { qeval: 0x4801, mps: 0, nlps: 28, nmps: 18 },
    State { qeval: 0x4801, mps: 1, nlps: 29, nmps: 19 },
    State { qeval: 0x3801, mps: 0, nlps: 28, nmps: 20 },
    State { qeval: 0x3801, mps: 1, nlps: 29, nmps: 21 },
    State { qeval: 0x3001, mps: 0, nlps: 34, nmps: 22 },
    State { qeval: 0x3001, mps: 1, nlps: 35, nmps: 23 },
    State { qeval: 0x2401, mps: 0, nlps: 36, nmps: 24 },
    State { qeval: 0x2401, mps: 1, nlps: 37, nmps: 25 },
    State { qeval: 0x1c01, mps: 0, nlps: 40, nmps: 26 },
    State { qeval: 0x1c01, mps: 1, nlps: 41, nmps: 27 },
    State { qeval: 0x1601, mps: 0, nlps: 42, nmps: 58 },
    State { qeval: 0x1601, mps: 1, nlps: 43, nmps: 59 },
    State { qeval: 0x5601, mps: 0, nlps: 29, nmps: 30 },
    State { qeval: 0x5601, mps: 1, nlps: 28, nmps: 31 },
    State { qeval: 0x5401, mps: 0, nlps: 28, nmps: 32 },
    State { qeval: 0x5401, mps: 1, nlps: 29, nmps: 33 },
    State { qeval: 0x5101, mps: 0, nlps: 30, nmps: 34 },
    State { qeval: 0x5101, mps: 1, nlps: 31, nmps: 35 },
    State { qeval: 0x4801, mps: 0, nlps: 32, nmps: 36 },
    State { qeval: 0x4801, mps: 1, nlps: 33, nmps: 37 },
    State { qeval: 0x3801, mps: 0, nlps: 34, nmps: 38 },
    State { qeval: 0x3801, mps: 1, nlps: 35, nmps: 39 },
    State { qeval: 0x3401, mps: 0, nlps: 36, nmps: 40 },
    State { qeval: 0x3401, mps: 1, nlps: 37, nmps: 41 },
    State { qeval: 0x3001, mps: 0, nlps: 38, nmps: 42 },
    State { qeval: 0x3001, mps: 1, nlps: 39, nmps: 43 },
    State { qeval: 0x2801, mps: 0, nlps: 38, nmps: 44 },
    State { qeval: 0x2801, mps: 1, nlps: 39, nmps: 45 },
    State { qeval: 0x2401, mps: 0, nlps: 40, nmps: 46 },
    State { qeval: 0x2401, mps: 1, nlps: 41, nmps: 47 },
    State { qeval: 0x2201, mps: 0, nlps: 42, nmps: 48 },
    State { qeval: 0x2201, mps: 1, nlps: 43, nmps: 49 },
    State { qeval: 0x1c01, mps: 0, nlps: 44, nmps: 50 },
    State { qeval: 0x1c01, mps: 1, nlps: 45, nmps: 51 },
    State { qeval: 0x1801, mps: 0, nlps: 46, nmps: 52 },
    State { qeval: 0x1801, mps: 1, nlps: 47, nmps: 53 },
    State { qeval: 0x1601, mps: 0, nlps: 48, nmps: 54 },
    State { qeval: 0x1601, mps: 1, nlps: 49, nmps: 55 },
    State { qeval: 0x1401, mps: 0, nlps: 50, nmps: 56 },
    State { qeval: 0x1401, mps: 1, nlps: 51, nmps: 57 },
    State { qeval: 0x1201, mps: 0, nlps: 52, nmps: 58 },
    State { qeval: 0x1201, mps: 1, nlps: 53, nmps: 59 },
    State { qeval: 0x1101, mps: 0, nlps: 54, nmps: 60 },
    State { qeval: 0x1101, mps: 1, nlps: 55, nmps: 61 },
    State { qeval: 0x0ac1, mps: 0, nlps: 56, nmps: 62 },
    State { qeval: 0x0ac1, mps: 1, nlps: 57, nmps: 63 },
    State { qeval: 0x09c1, mps: 0, nlps: 58, nmps: 64 },
    State { qeval: 0x09c1, mps: 1, nlps: 59, nmps: 65 },
    State { qeval: 0x08a1, mps: 0, nlps: 60, nmps: 66 },
    State { qeval: 0x08a1, mps: 1, nlps: 61, nmps: 67 },
    State { qeval: 0x0521, mps: 0, nlps: 62, nmps: 68 },
    State { qeval: 0x0521, mps: 1, nlps: 63, nmps: 69 },
    State { qeval: 0x0441, mps: 0, nlps: 64, nmps: 70 },
    State { qeval: 0x0441, mps: 1, nlps: 65, nmps: 71 },
    State { qeval: 0x02a1, mps: 0, nlps: 66, nmps: 72 },
    State { qeval: 0x02a1, mps: 1, nlps: 67, nmps: 73 },
    State { qeval: 0x0221, mps: 0, nlps: 68, nmps: 74 },
    State { qeval: 0x0221, mps: 1, nlps: 69, nmps: 75 },
    State { qeval: 0x0141, mps: 0, nlps: 70, nmps: 76 },
    State { qeval: 0x0141, mps: 1, nlps: 71, nmps: 77 },
    State { qeval: 0x0111, mps: 0, nlps: 72, nmps: 78 },
    State { qeval: 0x0111, mps: 1, nlps: 73, nmps: 79 },
    State { qeval: 0x0085, mps: 0, nlps: 74, nmps: 80 },
    State { qeval: 0x0085, mps: 1, nlps: 75, nmps: 81 },
    State { qeval: 0x0049, mps: 0, nlps: 76, nmps: 82 },
    State { qeval: 0x0049, mps: 1, nlps: 77, nmps: 83 },
    State { qeval: 0x0025, mps: 0, nlps: 78, nmps: 84 },
    State { qeval: 0x0025, mps: 1, nlps: 79, nmps: 85 },
    State { qeval: 0x0015, mps: 0, nlps: 80, nmps: 86 },
    State { qeval: 0x0015, mps: 1, nlps: 81, nmps: 87 },
    State { qeval: 0x0009, mps: 0, nlps: 82, nmps: 88 },
    State { qeval: 0x0009, mps: 1, nlps: 83, nmps: 89 },
    State { qeval: 0x0005, mps: 0, nlps: 84, nmps: 90 },
    State { qeval: 0x0005, mps: 1, nlps: 85, nmps: 91 },
    State { qeval: 0x0001, mps: 0, nlps: 86, nmps: 90 },
    State { qeval: 0x0001, mps: 1, nlps: 87, nmps: 91 },
